...
# We can find the exact indices. The nav starts with '<div data-collapse="medium"' and ends right before '<main class="main-wrapper"'
start_idx_index = idx_html.find('<div data-collapse="medium"')
...
if start_idx_index == -1 or end_idx_index == -1:
    ...
    start_tgt_index = tgt_html.find('<div data-collapse="medium"')
