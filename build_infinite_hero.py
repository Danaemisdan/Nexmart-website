...
def run():
    ...
    :root {
        ...
        --mist-blue: #E2E8F0;        
        --ambient-blue: rgba(14, 165, 233, 0.15); 
    ...
    body, html {
        ...
        /* The entire body background must seamlessly transition into the deep navy without ANY horizontal banding */
        background: var(--midnight-navy);
        background-image: linear-gradient(180deg, 
            var(--warm-white) 0vh, 
            var(--warm-white) 30vh,
            var(--soft-silver) 50vh, 
            var(--midnight-navy) 90vh,
            var(--midnight-navy) 100%);
        background-attachment: fixed; /* Prevents scrolling bands */
    ...
    .bg-grid {
        ...
        z-index: 0;
        pointer-events: none;
        -webkit-mask-image: linear-gradient(180deg, black 0%, black 50%, transparent 90%);
        mask-image: linear-gradient(180deg, black 0%, black 50%, transparent 90%);
    }

    /* SEAMLESS FLOW CONTAINER - No backgrounds here to avoid overlapping gradients */
    ...
    /* 
      ...
      We eliminate the border completely. It is purely an atmospheric zone that dissolves into the body background. 
    */
    .v1-app-environment {
        width: 100vw; 
        max-width: 1800px;
        /* Very subtle illumination, blending directly into the body's midnight-navy */
        background: radial-gradient(ellipse at top center, rgba(30, 41, 59, 0.5) 0%, transparent 70%);
        z-index: 20;
        padding-top: 240px; 
        padding-bottom: 400px; 
        position: relative;
        /* Aggressive mask fading the entire app content to ZERO opacity at the bottom */
        -webkit-mask-image: linear-gradient(180deg, black 0%, black 40%, transparent 95%);
    ...
    .ambient-reflection-left {
        ...
        width: 600px;
        height: 600px;
        background: radial-gradient(ellipse at center, var(--ambient-blue) 0%, transparent 60%);
        pointer-events: none;
    }
    ...
    <div class="seamless-page-wrapper">
        ...
        <!-- THE CONTINUOUS INFINITE ENVIRONMENT (NO BOUNDARIES) -->
    ...
    print("Invisible Boundary update complete.")
